    ...
    <section className="bg-lightGray">
      <div className="mx-auto max-w-6xl px-4 py-14">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
          ...
          <Link href="/reviews" className="text-sm font-semibold text-autoRed hover:text-red-700">
            See all reviews
          </Link>
        </div>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((quote, i) => (
            <blockquote key={quote} className="rounded-2xl border border-midGray/30 bg-lightGray p-5 shadow-card">
        ...
        <div className="mt-8 rounded-2xl border border-dashed border-midGray/40 bg-lightGray p-6 text-sm text-midGray">
